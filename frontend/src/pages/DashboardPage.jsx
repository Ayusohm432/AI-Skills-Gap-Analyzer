                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex gap-1.5 mt-2 text-[10px] font-semibold">
                              <span className="px-1.5 py-0.5 rounded bg-[var(--accent-teal-dim)] text-[var(--accent-teal)] border border-[var(--accent-teal)]/15">✓ {matchedCount} matched</span>
                              <span className="px-1.5 py-0.5 rounded bg-[var(--accent-coral-dim)] text-[var(--accent-coral)] border border-[var(--accent-coral)]/15">✗ {missingCount} missing</span>
                            </div>
                          </div>
                        </motion.div>
                      );
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    {d && (
                                      <div className="flex gap-1.5 mt-1.5 text-[9px] font-semibold">
                                        <span className="px-1.5 py-0.5 rounded bg-[var(--accent-teal-dim)] text-[var(--accent-teal)] border border-[var(--accent-teal)]/15">✓ {d.matched_skills?.length ?? 0}</span>
                                        <span className="px-1.5 py-0.5 rounded bg-[var(--accent-coral-dim)] text-[var(--accent-coral)] border border-[var(--accent-coral)]/15">✗ {d.missing_skills?.length ?? 0}</span>
                                      </div>
                                    )}
                                  </div>
                                </motion.div>
