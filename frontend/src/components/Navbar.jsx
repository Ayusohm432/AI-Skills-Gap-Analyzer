          ...
          >
            <div className="px-6 py-4 space-y-1">
              ...
              <div className="pt-3 border-t border-[var(--border-subtle)] mt-3 space-y-1">
                <Link to="/login" className="block px-4 py-3 rounded-lg text-sm text-[var(--text-secondary)] hover:bg-[var(--bg-elevated)]">
                  Sign in
                </Link>
                <Link to="/register" className="block px-4 py-3 rounded-lg text-sm font-medium text-[var(--accent-warm)]">
                  Create account
                </Link>
              </div>
            </div>
